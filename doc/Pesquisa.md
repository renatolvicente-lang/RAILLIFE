<h1>Pesquisa CRUD em PHP</h1>

<h2>O que é um CRUD?</h2>

<p>A palavra CRUD vem do inglês, das palavras (Create, Read, Update e Delete) que quer dizer as quatro principais funções de um BD(Criar, Ler, Atualizar e Deletar).</p>
